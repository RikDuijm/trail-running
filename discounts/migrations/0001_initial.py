    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(choices=[('watches', 'watches'), ('clothes', 'clothes'), ('shoes', 'shoes'), ('events', 'events')], default='shoes', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='skus', to='discounts.Product')),
            ],
        ),
    ]
